...
namespace ProductsManager.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PriceListPositions_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                name: "CustomerCustomerState",
                columns: table => new
                {
                    CustomerStatesId = table.Column<int>(type: "int", nullable: false),
                    CustomersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCustomerState", x => new { x.CustomerStatesId, x.CustomersId });
                    table.ForeignKey(
                        name: "FK_CustomerCustomerState_CustomerStates_CustomerStatesId",
                        column: x => x.CustomerStatesId,
                        principalTable: "CustomerStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerCustomerState_Customers_CustomersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCustomerState_CustomersId",
                table: "CustomerCustomerState",
                column: "CustomersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceListPositions_ProductId",
                table: "PriceListPositions",
                column: "ProductId");
